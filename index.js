/*Variables de los módulos de gestión*/
...
var mongoURL = "mongodb://manu:admin@ds051873.mlab.com:51873/sos1617sep";
var db = null;
...
var getDataName = function(req, res) {
...
var getDataNameYear = function(req, res) {
...
app.get("/api/v1/rape-stats/loadInitialData", getCreateData());
app.get("/api/v1/rape-stats", getAllData());
app.get("/api/v1/rape-stats", getAllData());

app.get("/api/v1/rape-stats/:name", getDataName());
app.get("/api/v1/rape-stats/:name/:year", getDataNameYear());

app.post("/api/v1/rape-stats", postNewData());
app.post("/api/v1/rape-stats/:name", badpost());
app.post("/api/v1/rape-stats/:name/:year", badpost());

app.put("/api/v1/rape-stats", badPut());
app.put("/api/v1/rape-stats/:name", badPut());
app.put("/api/v1/rape-stats/:name/:year", putTwoData());

app.delete("/api/v1/rape-stats", deleteCollection());
app.delete("/api/v1/rape-stats/:country", deleteData());
app.delete("/api/v1/rape-stats/:country/:year", deleteTwoData());
